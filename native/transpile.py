...
def transpile_with_runtime(path):
    ...
    header = (
        ...
        'import { show as $show, ask as $ask, read, write, append, exists, lines, read_bytes, write_bytes,\n'
        ...
        '  _ffi_fill_u32, _ffi_blend_u32, _ffi_box_blur, _ffi_copy, _ffi_write_buffer, _ffi_read_buffer,\n'
